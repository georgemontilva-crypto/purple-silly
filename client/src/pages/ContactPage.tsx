        ...
        <div className="max-w-[680px] mx-auto px-4 sm:px-6">
          ...
          <div className="mt-10 pt-8 border-t border-border grid grid-cols-1 sm:grid-cols-2 gap-6 text-sm text-muted-foreground">
            <div>
              ...
              <a
                href="tel:+18555526874"
                className="hover:text-[oklch(0.72_0.22_320)] transition-colors"
              >
                (855) 552-6874
              </a>
            </div>
            <div>
              ...
              <a
                href="mailto:info@purple-co.com"
                className="hover:text-[oklch(0.72_0.22_320)] transition-colors"
              >
                info@purple-co.com
              </a>
            ...
            <div>
              ...
              <address className="not-italic">
                5101 Tampa West Blvd, Suite 200
                <br />
                Tampa, FL 33634
              </address>
            </div>
