  ...
  return (
    <div style={{ background: C.deep, minHeight: "100vh", color: "white" }}>
      ...
      >
        ...
        >
          We're on a mission to illuminate the profound benefits of mushrooms —
          transforming traditional perceptions and proving that potent effects
          can be achieved sustainably and safely.
        </p>
      </div>
              ...
              <div
                ...
                onMouseEnter={e => {
                  ...
                  (e.currentTarget as HTMLElement).style.borderColor =
                    oklchAlpha(v.accent, 60);
                }}
                onMouseLeave={e => {
                  (e.currentTarget as HTMLElement).style.transform =
                    "translateY(0)";
                  (e.currentTarget as HTMLElement).style.borderColor =
                    oklchAlpha(v.accent, 30);
                }}
              >
                <div
                  style={{
      ...
      >
        ...
        >
          Join Our <span style={{ color: C.pink }}>#GetGroovyPurple</span>{" "}
          Community
        </h2>
        <p
          style={{
        ...
        >
          Follow us on Instagram and Facebook for product launches, exclusive
          content, and community vibes.
        </p>
        <div
          style={{
            display: "flex",
        ...
        >
          <a
            ...
            style={{
              ...
              border: `1.5px solid ${oklchAlpha(C.pink, 50)}`,
              color: "white",
              fontWeight: 700,
              fontSize: "0.9rem",
              textDecoration: "none",
          ...
          <a
            ...
            style={{
              ...
              padding: "0.875rem 1.75rem",
              borderRadius: "999px",
              background: oklchAlpha(C.vivid, 20),
              border: `1.5px solid ${oklchAlpha(C.vivid, 50)}`,
              color: "white",
              fontWeight: 700,
              fontSize: "0.9rem",
              textDecoration: "none",
