...
const allFaqs = [
  ...
  { q: "Is Kanna an Alternative to Alcohol?", a: "Many of our customers use Ferris Wheel products as a social alternative to alcohol. Kanna delivers a feel-good, social experience without the calories, hangovers, or next-day regret associated with drinking. It's a clean, plant-powered way to elevate your social experiences." },
  ...
  { q: "Can I Mix Kanna With Caffeine or Alcohol?", a: "Ferris Wheel Party Tablets contain caffeine and L-Theanine, which work synergistically with kanna. We do not recommend mixing our products with alcohol or additional stimulants. Always use responsibly and consult your physician if you have any concerns." },
  { q: "Are There Any Medications I Cannot Mix With Kanna?", a: "Kanna may interact with certain medications, particularly SSRIs, MAOIs, and other serotonergic drugs. If you are taking any prescription medications, please consult your physician before using Ferris Wheel products." },
    ...
    <div className="min-h-screen flex flex-col">
      ...
      <main className="flex-1 py-16">
        <div className="max-w-[860px] mx-auto px-4 sm:px-6">
          ...
          <p className="text-gray-500 text-lg mb-10">Everything you need to know about Ferris Wheel and Kanna.</p>
