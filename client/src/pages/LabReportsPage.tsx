  ...
  return (
    <div style={{ background: C.deep, minHeight: "100vh", color: C.text }}>
      ...
      >
        ...
        >
          Every Purple Co product is third-party tested for purity, potency, and
          safety. Download our Certificates of Analysis below.
        </p>
      </Reveal>
      ...
      >
        <button
          ...
          style={{
            ...
            background:
              activeCat === undefined ? oklchAlpha(C.vivid, 20) : "transparent",
        ...
        {categories?.map(cat => (
          <button
            ...
            style={{
              ...
              background:
                activeCat === cat.id ? oklchAlpha(C.vivid, 20) : "transparent",
                ...
                >
                  ...
                  <span
                    style={{
                      ...
                      borderRadius: "999px",
                      background: oklchAlpha(C.vivid, 18),
                      border: `1px solid ${oklchAlpha(C.vivid, 30)}`,
                      color: C.vivid,
                      fontSize: "0.7rem",
                      fontWeight: 700,
